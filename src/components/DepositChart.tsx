...
const DepositChart: React.FC<DepositChartProps> = ({ data }) => {
    ...
    return (
        <div className="h-full w-full bg-base-100/30 rounded-[3rem] p-6 xl:p-10 border border-base-300 shadow-inner flex flex-col xl:flex-row gap-8 xl:gap-12 items-stretch overflow-hidden">
            {/* Visual Pane */}
